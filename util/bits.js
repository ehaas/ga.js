...
var Bits = {
    ...
    highestOneBit: function(i) {
        return 31 - Bits.numberOfLeadingZeroBits(i);
    },
    ...
    lowestOneBit: function(i) {
        return Bits.numberOfTrailingZeroBits(i);
    },
     ...
     */
    numberOfLeadingZeroBits: function(i) {
